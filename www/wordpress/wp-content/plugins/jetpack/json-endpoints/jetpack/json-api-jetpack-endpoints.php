...
new Jetpack_JSON_API_Sync_Status_Endpoint(
	array(
		'description'             => 'Status of the current connected sync or the previous connected sync',
		'method'                  => 'GET',
		...
		'response_format'         => array(
			...
			'config'                => '(array) Configuration of the last connected sync',
			...
			'full_queue_size'       => '(int) Number of items in the connected sync queue',
			'full_queue_lag'        => '(float) Time delay of the oldest item in the connected sync queue',
			'full_queue_next_sync'  => '(float) Time in seconds before trying to sync the connected sync queue again',
...
$sync_settings_response = array(
	...
	'queue_max_writes_sec'     => '(int|bool=false) Maximum writes per second to allow to the queue during connected sync.',
	...
	'max_enqueue_full_sync'    => '(int|bool=false) Maximum number of rows to enqueue during each connected sync process',
	'max_queue_size_full_sync' => '(int|bool=false) Maximum queue size that connected sync is allowed to use',
	'full_sync_send_duration'  => '(float) Max connected sync duration per request',
	...
	'enqueue_wait_time'        => '(int|bool=false) Wait time in seconds between attempting to continue a connected sync, via requests',
	'sync_sender_enabled'      => '(int|bool=false) Set to 1 or true to enable the default sender for the incremental queue.',
	'full_sync_sender_enabled' => '(int|bool=false) Set to 1 or true to enable the default sender for the "connected sync" queue.',
);
